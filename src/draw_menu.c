...
static void	menu_object(t_ptrs *ptrs, t_point *point)
{
...
static void	menu_camera(t_ptrs *ptrs, t_point *point)
{
...
static void	menu_options(t_ptrs *ptrs, t_point *point)
{
...
static void	menu_colors(t_ptrs *ptrs, t_point *point)
{
...
void	draw_menu(t_ptrs *ptrs)
{
	...
	menu_colors(ptrs, &point);
	menu_object(ptrs, &point);
	menu_camera(ptrs, &point);
	menu_options(ptrs, &point);
}
