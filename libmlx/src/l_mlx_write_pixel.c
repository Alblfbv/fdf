...
/*   Updated: 2019/09/12 19:18:33 by rkirszba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	l_mlx_write_pixel_pct(t_img *img, t_point *point, double percentage)
{
	...
	draw_point = *point;
	draw_point.color = (img->endian == LITTLE) ?\
	//		l_mlx_compute_color_big(0xFF, point->color, percentage)
			l_mlx_compute_color_big(0xFF, point->color, percentage) :\
			l_mlx_compute_color_little(0xFF, point->color, percentage);
